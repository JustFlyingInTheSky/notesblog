...
2. **父元素没有定位**，则以**浏览器**为准定位（Document 文档）。
   ...
   <img src="/05_绝对定位_父级无定位.png" width="700" />

3. **父元素要有定位**

   * 将元素依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

<img src="/06_绝对定位_父级有定位.png" width="700" />
...
- 解决的方法就是：  
  ...
  - 给img vertical-align:middle | top| bottom等等。  让图片不要和基线对齐。<img src="/1633.png"  width="500"  style="border: 1px dashed #ccc;" />

    

  - 给img 添加 display：block; 转换为块级元素就不会存在问题了。<img src="/sina1.png" width="500" style="border: 1px dashed #ccc;"/>
...
<img src="/jds.png"  style="border: 1px dashed #ccc;" />
